...
var PC = ["#2872c8","#c0392b","#27ae60","#e8b800","#8e44ad","#e67e22"];
var MEDALS = ["🥇","🥈","🥉"];
...
function renderWeeklyBar() {
  ...
  var colors = totals.map(function(v,i){ return i<4?'rgba(40,114,200,0.7)':'rgba(39,174,96,0.8)'; });
  _WEEKLY_CHART = new Chart(ctx, {
    ...
    options:{
      ...
      scales:{
        x:{grid:{display:false},ticks:{font:{size:8,family:'Nunito'},color:'#7a90aa',maxRotation:35}},
        y:{grid:{color:'rgba(0,0,0,0.05)'},ticks:{font:{size:8},color:'#7a90aa'},beginAtZero:true}
      }
    }
  });
}
